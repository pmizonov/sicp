...
; точная, потому что для вычисления исмпользуется меньшее количество чисел с погрешностью.
...
; Пакет для работы с интервальной арифметикой, он должен уметь преобразовывать алгебраические выражения 
