...
; то происходит зацикливание и выполнения процедуры test не происходит,
; т.к. невозможно вычислить значение операнда

; При использовании нормального порядка вычисления, вначале будет выполняться полная подстановка значений.
